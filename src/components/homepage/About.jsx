...
function About(){
    return <div name="about" className="about section-container" id={"about"}>
        ...
        <div className="about-info">
            ...
            <p>אין לנו ספק שאתם תצאו מהסדנא בריאים יותר, חיוניים ומלאי אנרגיה והכי חשוב – מלאי מוטיבציה לעשות שינוי אמתי שישפיע לטובה על הבריאות הפיזית והנפשית שלכם ושל כל הסובבים אתכם. נשמח לראותכם מצטרפים לקהילת הבשלנים לומדים ומבשלים בהתמדה ונחישות , חווים את השינוי הגדול בכיף ובאיזון</p>
<p>כי עם שרון ולירון – פשוט לחיות בריא ונכון!!</p>
